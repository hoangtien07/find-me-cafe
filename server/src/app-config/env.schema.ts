...
export const envSchema = z.object({
  ...
  DECISION_MATRIX_PROVIDER: oneOf(['mock', 'google', 'osrm', 'vietmap', 'trackasia']),
  GOOGLE_ROUTES_API_KEY: anyString,
  GOOGLE_ROUTES_API_BASE: url,
  OSRM_MATRIX_API_BASE: url,
  VIETMAP_API_KEY: anyString,
  VIETMAP_API_BASE: url,
  TRACKASIA_API_KEY: anyString,
  TRACKASIA_API_BASE: url,
  DECISION_MATRIX_TIMEOUT_MS: integer(1000, 60000, 'must be an integer between 1000 and 60000 (ms)'),
  AMAP_API_BASE: url,
